...
public partial class ProfilePage : ContentPage
{
    ...
    {
        bool result = await DisplayAlert("Delete account?", $"Are you sure you want to delete your account: {currentCredentials.User.Email}? This process is unreversable", "Yes", "No");
        if (result)
        {
